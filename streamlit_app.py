    ...
    with st.container(border=True):
        ...
        if user_id:
            ...
            <div style="
                ...
                color: #333;
            ">
                <div style="position: absolute; top: -150px; left: -20px; transform: rotate(-20deg); opacity: 0.1; font-size: 40px; font-weight: bold; white-space: nowrap; pointer-events: none;">
